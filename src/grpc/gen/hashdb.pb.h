...
class SemiFlushRequest final :
 ...
 public:
  ...
  ~SemiFlushRequest() override;
  explicit PROTOBUF_CONSTEXPR SemiFlushRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SemiFlushRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SemiFlushRequest& from) {
    SemiFlushRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline uint64_t SetRequest::_internal_tx() const {
  return _impl_.tx_;
}
inline uint64_t SetRequest::tx() const {
  // @@protoc_insertion_point(field_get:hashdb.v1.SetRequest.tx)
  return _internal_tx();
}
inline void SetRequest::_internal_set_tx(uint64_t value) {
  
  _impl_.tx_ = value;
}
inline void SetRequest::set_tx(uint64_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SemiFlushRequest::set_batch_uuid(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SemiFlushRequest::set_new_state_root(ArgT0&& arg0, ArgT... args) {
